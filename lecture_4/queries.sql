...
-- ===================================================================
-- Файл: queries.sql
-- Описание: Создание БД school.db, вставка тестовых данных, создание индексов и
-- набор SQL-запросов для домашнего задания.
# Дополнительно: использованы комментарии в стиле '--' и '#' и разделители '---'.
---
